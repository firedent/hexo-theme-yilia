...
/***/ function(module, exports, __webpack_require__) {
	...
	var version = 'v20160443';
	var __DEVELOPMENT__ = false;
	var __DEBUG__ = false;
	var offlineResources = ['/', '/2017/03/30/3e16aa00/index.html', '/favicon.ico'];
	...
	function updateStaticCache() {
	  return caches.open(cacheKey('offline')).then(function (cache) {
	...
	function networkedOrCached(request) {
	  return networkedAndCache(request).catch(function () {
	...
	function cachedOrNetworked(request) {
	  return caches.match(request).then(function (response) {
	    ...
	    return response || networkedAndCache(request).catch(function () {
	...
	function removeOldCache() {
	  return caches.keys().then(function (keys) {
	    return _promise2.default.all( // We return a promise that settles when all outdated caches are deleted.
	...
	function shouldAlwaysFetch(request) {
	  return __DEVELOPMENT__ || request.method !== 'GET' || ignoreFetch.some(function (regex) {
